...
async def bot_start(call: types.CallbackQuery):
    await call.message.answer(f"Assalomu alaykum, {call.from_user.full_name}! Valyuta konvertori botimizga xusg kelibsiz. Marhamat quyidagi bo'limlardan birini tanlang.", reply_markup=mainKey)
